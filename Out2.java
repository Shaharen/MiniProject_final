...
//		System.out.println("test : "+land.get(1).getLandOwner()+land.get(2).getLandOwner()+land.get(3).getLandOwner()+land.get(5).getLandOwner()+land.get(6).getLandOwner()+land.get(7).getLandOwner());
		...
		System.out.println(
				"+---------------+---------------+---------------+---------------+---------------+---------------+---------------+---------------+---------------+");
		System.out.println("|7 " + ownerCheck(land.get(7).getLandOwner(), land.get(7).getLandCnt()) + "|"+ "당신의 말 : [○]" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "|17"+ ownerCheck(land.get(17).getLandOwner(), land.get(17).getLandCnt()) +"|");
		System.out.println("|사당동\t\t|" + "당신의 땅 : [@]" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "|성수동\t\t|");
		System.out.println("|" + go7(userWhere, pcWhere)+ "\t\t|\t\t"+"\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t"+ "\t\t|"  + go17(userWhere, pcWhere) + "\t\t|");
		System.out.println("|\t\t|" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "|\t\t|");
		
		System.out.println("+---------------+                                                                                                               +---------------+");
		System.out.println("|6 " + ownerCheck(land.get(6).getLandOwner(), land.get(6).getLandCnt()) + "|"+ "PBK의 말 : [●]" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "|18"+ ownerCheck(land.get(18).getLandOwner(), land.get(18).getLandCnt()) + "|");
		System.out.println("|신당동\t\t|" + "PBK의 땅 : [#]" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t|수유동\t\t|");
		System.out.println("|" + go6(userWhere, pcWhere)+  "\t\t|\t\t"+"\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t"+"\t\t|"   + go18(userWhere, pcWhere) + "\t\t|");
		System.out.println("|\t\t|" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "|\t\t|");
      
		System.out.println("+---------------+                                                                                                               +---------------+");
		System.out.println("|5 " + ownerCheck(land.get(5).getLandOwner(), land.get(5).getLandCnt()) + "|\t\t"+"\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t"+ "\t\t|19"+ ownerCheck(land.get(19).getLandOwner(), land.get(19).getLandCnt()) + "|");
		System.out.println("|도곡동" +"\t\t|\t\t"+"\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" +  "\t\t|반포동\t\t|");
		System.out.println("|" + go5(userWhere, pcWhere) + "\t\t|\t\t"+"\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t"+"\t\t|"   + go19(userWhere, pcWhere) + "\t\t|");
		System.out.println("|\t\t|" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "|\t\t|");

		System.out.println("+---------------+                                                                                                               +---------------+");
		System.out.println("|4 " + ownerCheck(land.get(4).getLandOwner(), land.get(4).getLandCnt())  +"|\t\t"+"\t\t" + "\t\t" + "\t\t" + "\t\t"+ "\t\t" + "\t\t|20" +ownerCheck(land.get(20).getLandOwner(), land.get(20).getLandCnt()) + "\t|");
		System.out.println("|보너스"+"\t\t|\t\t"+"\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t|삼성동" + "\t\t|");
		System.out.println("|" + go4(userWhere, pcWhere)+  "\t\t|\t\t"+"\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" +  "\t\t|"  + go20(userWhere, pcWhere) + "\t\t|");
		System.out.println("|\t\t|" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "|\t\t|");
        
		System.out.println("+---------------+                                                                                                               +---------------+");
		System.out.println("|3 " + ownerCheck(land.get(3).getLandOwner(), land.get(3).getLandCnt())+  "|\t\t"+"\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t"+ "\t\t|21"+ ownerCheck(land.get(21).getLandOwner(), land.get(21).getLandCnt()) + "|");
		System.out.println("|노량진동"+"\t|\t\t"+"\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t"+"\t\t"   + "|신계동\t\t|");
		System.out.println("|" + go3(userWhere, pcWhere) + "\t\t|\t\t"+"\t\t" + "\t\t" + "\t\t" +  "\t\t"+"\t\t" + "\t\t|" + go21(userWhere, pcWhere) + "\t\t|");
		System.out.println("|\t\t|" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "|\t\t|");

		System.out.println("+---------------+                                                                                                               +---------------+");
		System.out.println("|2 " + ownerCheck(land.get(2).getLandOwner(), land.get(2).getLandCnt())+ "|\t\t"+"\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t|22" +"\t\t|");
		System.out.println("|방배동"+"\t\t|\t\t"+"\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t|" +"보너스\t\t|");
		System.out.println("|" + go2(userWhere, pcWhere)+  "\t\t|\t\t"+"\t\t" + "\t\t" + "\t\t" + "\t\t"+"\t\t" + "\t\t|"  +  go22(userWhere, pcWhere) + "\t\t|");
		System.out.println("|\t\t|" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "|\t\t|");
		
		System.out.println("+---------------+                                                                                                               +---------------+");
		System.out.println("|1 " + ownerCheck(land.get(1).getLandOwner(), land.get(1).getLandCnt())+ "|\t\t"+"\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t|23" + ownerCheck(land.get(23).getLandOwner(), land.get(23).getLandCnt()) + "|");
		System.out.println("|안암동"+"\t\t|\t\t"+"\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t"+ "\t\t|" + "수서동\t\t|");
		System.out.println("|" + go1(userWhere, pcWhere)+  "\t\t|\t\t"+"\t\t" + "\t\t" + "\t\t" +  "\t\t" + "\t\t" + "\t\t|"   + go23(userWhere, pcWhere) + "\t\t|");
		System.out.println("|\t\t|" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "\t\t" + "|\t\t|");
